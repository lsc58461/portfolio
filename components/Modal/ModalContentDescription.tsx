...
function ModalContentDescription({ projectOrder, children }: Props) {
  return (
    <section className='h-487pxr flex-[1_0_0%] overflow-hidden overflow-y-scroll '>
      <div className='flex min-h-487pxr flex-col gap-20pxr border border-[#4d4d4d] p-20pxr'>
